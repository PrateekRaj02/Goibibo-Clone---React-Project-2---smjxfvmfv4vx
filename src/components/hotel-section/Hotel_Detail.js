...
export default function Hotel_Detail() {
  ...
  const getHotelData = async () => {
    const apiUrl = baseUrl + `hotel/${hotelID}`;
              ...
              <Stack direction={"row"} gap={4}>
                ...
                >
                  ...
                  <Typography fontSize={20} fontWeight={600}>
                    {getRating((hotel.rating * 1.9).toFixed(1))}
                  </Typography>
                </Stack>
                <Stack
                  direction={"row"}
                  ...
                  (
                    ...
                    return (
                      ...
                      >
                        ...
                        <Stack>
                          <Typography fontSize={20} fontWeight={600}>
                            {CURRENCY_FORMATTER(costPerNight * rooms)}
                          </Typography>
                          <Typography fontSize={12} color={"rgb(94, 97, 110)"}>
                            +{CURRENCY_FORMATTER(costPerNight * 0.18 * rooms)}{" "}
                            taxes and fees per night for {rooms}{" "}
                            {rooms === 1 ? "room" : "rooms"}
                          </Typography>
                        </Stack>
                        <Button
                          onClick={() =>
                            handleBookButton(costPerNight, bedDetail)
                          }
                          variant="contained"
                          disableRipple
                          sx={{
                        ...
                        >
                          Reserve {rooms} {rooms === 1 ? "room" : "rooms"}
                        </Button>
                      </Stack>
                    );
                  }
            ...
            <TabPanel value={tabIndex} index={2}>
              ...
              >
                <Stack direction={"row"}>
                  ...
                  <Typography fontSize={15}>From 15:00</Typography>
                </Stack>
                <Stack direction={"row"}>
                  <Stack
                    direction={"row"}
                  ...
                  <Typography fontSize={15}>Till 12:00</Typography>
                </Stack>
                <Stack direction={"row"} alignItems={"flex-start"}>
                  ...
                  <Stack gap={1}>
                    {CHILD_AND_EXTRA_BEDS.map(({ head, body }) => {
                      return (
                        <Typography key={head} fontSize={15}>
                          <span
                            style={{
                              fontWeight: 600,
                            }}
                    ...
                    <Typography fontSize={15}>
                      <span style={{ fontWeight: 600 }}>Extra Bed Charges</span>{" "}
                      -{" "}
                      {CURRENCY_FORMATTER(
                        hotel?.childAndExtraBedPolicy?.extraBedCharge
                      )}
                    </Typography>
                  </Stack>
                </Stack>
