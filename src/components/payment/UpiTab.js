...
import phonepeImg from "../../assets/payment/jp_phonepe.png";
import googlepayImg from "../../assets/payment/jp_googlepay.png";
import paytmImg from "../../assets/payment/jp_paytm.png";
import cred_logoImg from "../../assets/payment/jp_cred_logo.png";
import amazonpayImg from "../../assets/payment/jp_amazonpay.png";
import bhimImg from "../../assets/payment/jp_bhim.png";
        ...
        <>
          {!qrCodeGenerated && (
            <Stack>
              <Stack direction={"row"} justifyContent={"space-between"}>
                <Stack gap={2} sx={{ p: 3 }} alignItems={"flex-start"}>
                  <Typography fontWeight={600}>Pay by an UPI app</Typography>
                  <Typography fontSize={14} color={"rgba(0,0,0,0.6)"}>
                    Scan the QR using any UPI app on your mobile phone line
                  ...
                  <Box>
                    <Button
                      ...
                      sx={{
                        ...
                        cursor: generatingQR ? "default" : "pointer",
                      }}
                    >
              ...
              <Stack gap={1.5} sx={{ p: 3 }} alignItems={"flex-start"}>
                <Typography color={"#ec5b24"}>UPI ID / VPA</Typography>
                <TextField
                  variant="standard"
                  InputLabelProps={{
                    shrink: true,
          ...
          {qrCodeGenerated && (
            ...
            >
              ...
              >
                <IoIosArrowBack size={24} color="rgba(0,0,0,0.6)" />
